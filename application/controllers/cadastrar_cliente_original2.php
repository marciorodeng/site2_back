	...
	if(in_array('',$dados)){
		...
		*/
		...
		if($cadastrar == 1){
			...
			$result_cliente = "INSERT INTO App_Cliente (idSis_Empresa, idTab_Modulo, idSis_Usuario, idSis_Associado, NomeCliente, CelularCliente, CodInterno, Codigo, DataCadastroCliente, LocalCadastroCliente, usuario, senha) VALUES (
							'" .$idSis_Empresa. "',
							'1',
							'" .$usuario_vend. "',

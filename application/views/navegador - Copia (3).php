				...
				<ul class="nav navbar-nav navbar-right navbar-fonte">
					...
					<?php if($row_empresa['EComerce'] == 'S'){ ?>
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdown01">
								...
								if(mysqli_num_rows($read_categoria_produtos) > '0'){?>							
									<li>
										<a class="dropdown-item" href="index.php?cat=prd" >
											Produtos
										</a>
									</li>
									<li role="separator" class="divider"></li>
								...
								if(mysqli_num_rows($read_categoria_servicos) > '0'){?>
									<li>
										<a class="dropdown-item" href="index.php?cat=srv" >
											Serviços
										</a>
									</li>
									<li role="separator" class="divider"></li>
								...
								if(mysqli_num_rows($read_categoria_promocao) > '0'){?>	
									<li>
										<a class="dropdown-item" href="index.php?cat=prm" >
											Promoções
										</a>
									</li>
									<li role="separator" class="divider"></li>
						...
						<?php
							...
							if(mysqli_num_rows($read_categoria_produtos) > '0'){?>
								<li class="dropdown">
									<a class="nav-link dropdown-toggle" style="color: #8a8a8a" href="#" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										Produtos <span class="caret"></span>
									</a>
									<ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdown02">
										<?php
						...
						<?php
							...
							if(mysqli_num_rows($read_categoria_promocao) > '0'){?>
								<li class="dropdown">
									<a class="nav-link dropdown-toggle" style="color: #8a8a8a" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										Promoções <span class="caret"></span>
									</a>
									<ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdown04">
										<?php

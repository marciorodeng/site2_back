					...
					<form name="Form" id="Form" action="?acao=up" method="post">
											...
											<div class="row img-prod-pag">	
												<div class="col-md-12">	
													...
													<div class="col-md-2">
														<div class="row ">	
															<div class="col-md-12 ">
																<h5 class="my-0"><?php echo utf8_encode ($read_produto_carrinho_view['Produtos']);?></h5> 
															</div>
														</div>	
														<div class="row ">	
															<div class="col-md-12">
													...
													<div class="col-md-8">		
														<div class="row ">
															...
															-->
															<div class="col-md-3 ">
																<h4 class="my-0"><span class="text-muted">Qtd </span><br><span id="Qtd<?php echo $item_carrinho;?>"  name="prod[<?php echo $id_produto_carrinho ?>]" value="" ><?php echo $quantidade_produto_carrinho ?></span><span class="text-muted"> X </span></h4> 
															</div>															
															<div class="col-md-3 ">
																<h4 class="my-0"><span class="text-muted">Valor (Unid) </span><br>R$<span id="Valor<?php echo $item_carrinho;?>" value=""><?php echo number_format($read_produto_carrinho_view['ValorProduto'],2,",",".");?></span><span class="text-muted"> =</span></h4> 
															</div>
															<div class="col-md-3 ">
						...
						<div class="row">	
							<div class="col-md-4 card-body text-left">
								<a href="meu_carrinho.php" class="btn btn-success">Voltar ao Carrinho</a>
						...
						<form name="FormularioEntrega" id="FormularioEntrega" method="post" action="finalizar_pedido.php" >
							...
							<div class="row Liga">
								<div class="col-md-9 mb-3 Retirada">
									<h5><?php echo $row_empresa['EnderecoEmpresa'];?>, <?php echo $row_empresa['NumeroEmpresa'];?> - <?php echo $row_empresa['ComplementoEmpresa'];?><br>

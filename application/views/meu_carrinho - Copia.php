						...
						<form name="Form" id="Form" action="?acao=up-produtos" method="post">
							<ul class="list-group mb-3 ">										
								<?php
									...
									$total_produtos = '0';
									$prazo_carrinho = '0';
									if(isset($_SESSION['Site_Back']['carrinho'.$_SESSION['Site_Back']['id_Cliente'.$idSis_Empresa]]) && count($_SESSION['Site_Back']['carrinho'.$_SESSION['Site_Back']['id_Cliente'.$idSis_Empresa]]) > '0'){
										foreach($_SESSION['Site_Back']['carrinho'.$_SESSION['Site_Back']['id_Cliente'.$idSis_Empresa]] as $id_produto_carrinho => $quantidade_produto_carrinho){
											$item_carrinho++;
									...
									$_SESSION['Site_Back']['item_carrinho'.$_SESSION['Site_Back']['id_Cliente'.$idSis_Empresa]] = $item_carrinho;
									$_SESSION['Site_Back']['total_produtos'.$_SESSION['Site_Back']['id_Cliente'.$idSis_Empresa]] = $total_produtos;
									/*
									echo "<pre>";
									echo $item_carrinho;
									echo "<br>";
								...
								<div class="row">	
									<div class="col-md-6 card-body text-left">
										<?php if($row_empresa['EComerce'] == 'S'){ ?>
											<?php if(count($_SESSION['Site_Back']['carrinho'.$_SESSION['Site_Back']['id_Cliente'.$idSis_Empresa]]) > '0'){ ?>

												...
												<div class="row ">	
													<div class="col-md-12">	
														<div class="col-md-2">		
															<div class="row ">
																<div class="container-2">
																	...
																	<div class="col-md-8">
																		<img class="team-img img-circle img-responsive" src="<?php echo $idSis_Empresa ?>/produtos/miniatura/<?php echo $read_produto_carrinho_view['Arquivo']; ?>" alt="" width='300' >
																	</div>
																</div>
															</div>
														</div>	
														<div class="col-md-2">	
															<div class="row ">	
																<div class="col-md-12 ">
																	<span class=""><?php echo utf8_encode ($read_produto_carrinho_view['Promocao']);?></span>
																</div>
															</div>
															<div class="row ">	
																<div class="col-md-12 ">
														...
														<div class="col-md-2">		
															<div class="row ">
																...
																<div class="container-2">
																	<div class="col-md-6 ">
																		<h4 class="my-0"><span class="text-muted">Qtd </span><br><span id="SubQtd<?php echo $item_carrinho;?>" ><?php echo $sub_total_produtos;?> Un.</span></h4> 
																	</div>
																	<div class="col-md-6 ">

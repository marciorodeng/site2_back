	...
	<section id="contact" class="section-padding3">		
		<div class="container">
			<div class="form-signin" style="background: #aeb1ef;">
				...
				<?php } ?>			
				<h3>Solicito o meu Link de Associado a Empresa:<br> "<span style="color: #000080"><?php echo utf8_encode($row_empresa['NomeEmpresa']); ?></span>",<br> para ser um(a) divulgador(a) dos seus Produtos e/ou Serviços</h3>
				<?php

												...
												<div class="col-md-12">	
													...
													<div class="col-md-8">		
														<div class="row ">
															...
															<div class="col-md-4 ">
																<h4 class="my-0"><span class="text-muted">Qtd: </span><input class="text-muted" type="text" size="5" name="prod[<?php echo $id_produto_carrinho ?>]" value="<?php echo $quantidade_produto_carrinho ?>"/><span class="text-muted"> X </span></h4> 
															</div>
														...
														<div class="row ">
															<div class="col-md-4 ">
																<h4 class="my-0"><span class="text-muted">Valor: </span> R$<?php echo number_format($read_produto_carrinho_view['ValorProduto'],2,",",".");?><span class="text-muted"> =</span></h4> 
															</div>
															<div class="col-md-4 ">
																<h4 class="my-0"><span class="text-muted">SubTotal: </span>R$<?php echo number_format($sub_total_produto_carrinho,2,",",".");?></h4> 
															</div>
															<div class="col-md-4 ">

<section id="ecomerce" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			...
			<?php
				...
				if(!$cat || $cat == '' || (isset($cat) && $cat == 'prd')){
					...
					if(mysqli_num_rows($read_categoria_prd) > '0'){
						echo'
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<h1 class="title-h2">Categorias de Produtos</h2>
								<hr class="botm-line">
							</div>
						';
						foreach($read_categoria_prd as $read_categoria_view_prd){
							...
							echo'									
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<br>
									<h2 class="ser-title">'.$read_categoria_view_prd['Catprod'].'</h2>
									<hr class="botm-line">
									<div class="card-body">
				...
				if(!$cat || $cat == '' || (isset($cat) && $cat == 'srv')){
					...
					if(mysqli_num_rows($read_categoria_srv) > '0'){
						echo'
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<h1 class="title-h2">Categorias de Serviços</h2>
								<hr class="botm-line">
							</div>
						';
						foreach($read_categoria_srv as $read_categoria_view_srv){
							...
							echo'
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<br>
										<h2 class="ser-title">'.$read_categoria_view_srv['Catprod'].'</h2>
										<hr class="botm-line">
										<div class="card-body">
				...
				if(!$cat || $cat == '' || (isset($cat) && $cat == 'prm')){
					...
					if(mysqli_num_rows($read_categoria_prm) > '0'){
						echo'
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<h1 class="title-h2">Categorias de Promoções</h2>
								<hr class="botm-line">
							</div>
						';						
						foreach($read_categoria_prm as $read_categoria_view_prm){
							...
							echo'
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<br>
										<h2 class="ser-title">'.$read_categoria_view_prm['Catprom'].'</h2>
										<hr class="botm-line">
										<div class="card-body">

									...
									?>		
										<li class="list-group-item d-flex justify-content-between lh-condensed fundo">
												...
												<div class="row img-prod-pag">	
													<div class="col-md-3 ">
														<img class="team-img img-circle img-responsive" src="https://www.enkontraki.com.br/<?php echo $sistema ?>/arquivos/imagens/empresas/<?php echo $idSis_Empresa ?>/produtos/miniatura/<?php echo $read_produto_view['Arquivo']; ?>" alt="" width='50' >
													</div>														
													<div class="col-md-8 ">
														<div class="row">
					...
					<div class="col-md-7 order-md-1 fundo">
						...
						<form name="formPagamento" action="" id="formPagamento">
							...
							<div class="col-lg-12 creditCard">
									...
									<div class="row ">
										<div class="col-lg-12">	
											...
											<div class="col-md-6 mb-3 ">	
												<div class="custom-control custom-radio">
													<input type="radio" name="tipoendereco" class="custom-control-input" id="OutroEndereco" value="2" onclick="tipoEndereco('2')" checked>
													<label class="custom-control-label" for="OutroEndereco">Outro Endereço</label>
												</div>
											</div>											
											<div class="col-md-6 mb-3 ">	
												<div class="custom-control custom-radio">
													<input type="radio" name="tipoendereco" class="custom-control-input"  id="EnderecoCadastrado" value="1" onclick="tipoEndereco('1')">
								...
								<input type="hidden" name="RecarregaCepDestino" id="RecarregaCepDestino" value="<?php echo $_SESSION['Cep_Cliente'];?>">
								<input type="hidden" name="RecarregaLogradouro" id="RecarregaLogradouro" value="<?php echo $_SESSION['Endereco_Cliente'];?>">
								<input type="hidden" name="RecarregaNumero" id="RecarregaNumero" value="<?php echo $_SESSION['Numero_Cliente'];?>">
								<input type="hidden" name="RecarregaComplemento" id="RecarregaComplemento" value="<?php echo $_SESSION['Complemento_Cliente'];?>">
								<input type="hidden" name="RecarregaBairro" id="RecarregaBairro" value="<?php echo $_SESSION['Bairro_Cliente'];?>">
								<input type="hidden" name="RecarregaCidade" id="RecarregaCidade" value="<?php echo $_SESSION['Cidade_Cliente'];?>">
								<input type="hidden" name="RecarregaEstado" id="RecarregaEstado" value="<?php echo $_SESSION['Estado_Cliente'];?>">								
								...
								<div class="row">
									...
									<div class="row creditCard">
										<div class="col-md-3 mb-3 creditCard">
											...
											<input type="text" name="billingAddressPostalCode" class="form-control creditCard" id="billingAddressPostalCode" placeholder="CEP sem traço"  maxlength="8" value="<?php echo $_SESSION['Cep_Cliente'];?>" required>
										</div>
										<div class="col-md-3 mb-3 creditCard">	
									...
									<div class="row creditCard">
										<div class="col-md-9 mb-3 creditCard">
											...
											<input type="text" name="billingAddressStreet" id="billingAddressStreet" placeholder="Av. Rua" value="<?php echo $_SESSION['Endereco_Cliente'];?>" class="creditCard form-control" required>
										</div>                            
										<div class="col-md-3 mb-3 creditCard">
											<label class="creditCard">Número</label>
											<input type="text" name="billingAddressNumber" id="billingAddressNumber" placeholder="Número" value="<?php echo $_SESSION['Numero_Cliente'];?>" class="creditCard form-control" required>
										</div>
									</div>
									
									<div class="mb-3 creditCard">
										<label class="creditCard">Complemento</label>
										<input type="text" name="billingAddressComplement" id="billingAddressComplement" placeholder="Complemento" value="<?php echo $_SESSION['Complemento_Cliente'];?>" class="creditCard form-control">
									</div>

									<div class="row creditCard">
										<div class="col-md-5 mb-3 creditCard">
											<label class="creditCard">Bairro</label>
											<input type="text" name="billingAddressDistrict" id="billingAddressDistrict" placeholder="Bairro" value="<?php echo $_SESSION['Bairro_Cliente'];?>" class="creditCard form-control" required>
										</div>
										<div class="col-md-5 mb-3 creditCard">
											<label class="creditCard">Cidade</label>
											<input type="text" name="billingAddressCity" id="billingAddressCity" placeholder="Cidade" value="<?php echo $_SESSION['Cidade_Cliente'];?>" class="creditCard form-control" required>
										</div>
										<div class="col-md-2 mb-3 creditCard">
											...
											<select name="billingAddressState" class="form-control creditCard" id="billingAddressState" required>
												<option value="<?php echo $_SESSION['Estado_Cliente'];?>"><?php echo $_SESSION['Estado_Cliente'];?></option>
								...
								<div class="row">
									...
									<div class="row ">
										<div class="col-lg-12">	
											...
											<input type="hidden" name="idCliente" id="idCliente" value="<?php echo $_SESSION['id_Cliente'];?>">
										</div>
									</div>
								</div>							
							<br>

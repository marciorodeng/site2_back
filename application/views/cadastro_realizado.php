<?php
	$link = 'https://www.enkontraki.com.br/' . $row_empresa['Site'] . '/associado.php/?emp=' . $row_link['idSis_Empresa'] . '&usuario=' . $row_link['idSis_Associado'];
?>
<section id="cadastro" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">	
	...
	<div class="col-md-12" align="center">
		<div style="overflow: auto; height: auto; ">
			<a href="../<?php echo $row_empresa['Site'] ?>/associado.php/?emp=<?php echo $row_link['idSis_Empresa'] ?>&usuario=<?php echo $row_link['idSis_Associado'] ?>">
				https://www.enkontraki.com.br/<?php echo $row_empresa['Site'];?>/associado.php/?emp=<?php echo $row_link['idSis_Empresa'];?>&usuario=<?php echo $row_link['idSis_Associado'];?>
			</a>
		</div>
	</div>
	-->
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" align="center">
		<h3>Após acumular R$ 20,00 de saldo em comissões, na <span style="color: #000080"><?php echo $row_empresa['NomeEmpresa'];?></span>, você pode solicitar o resgate do valor para sua conta!</h3>
	</div>
</section>
<!--
<script>

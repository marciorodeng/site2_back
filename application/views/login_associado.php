		...
		<div class="row">					
			...
			<div class=" col-xs-12 col-sm-offset-1 col-sm-10 col-md-offset-2 col-md-8 col-lg-offset-3  col-lg-6 ">
				<div class="form-signin text-left" style="background: #900095;">				
					<h3>Acessar Link do Associado da <?php echo $row_empresa['NomeEmpresa']; ?></h3>
					<?php
					...
					<form method="POST" action="valida_associado.php">
						...
						<input type="text" name="CelularAssociado" placeholder="Ex: 21987654321" maxlength="11" class="form-control"><br>
...
<?php }else{ ?>
	<script> window.location = "produtos.php" </script>
<?php }?>
			...
			<?php
				...
				if(mysqli_num_rows($read_categoria_id) > '0'){
					foreach($read_categoria_id as $read_categoria_view_id){
						...
						$arquivo_catprod = $read_categoria_view_id['Arquivo'];
						$result_produto_id = "
												SELECT * 
												FROM 
													Tab_Produto as TP
						...
						echo'
								<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
									...
									<hr class="botm-line">
									<div class="card-body">
										<a href="produtos.php?cat='.$read_categoria_view_id['idTab_Catprod'].'>">
											<img class="team-img img-responsive " src="'.$idSis_Empresa.'/produtos/miniatura/'.$read_categoria_view_id['Arquivo'].'" alt="" width="500">
										</a>
									</div>
								</div>
						';

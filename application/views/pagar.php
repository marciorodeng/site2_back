...
<section id="pagar" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="col-md-5 col-sm-5 order-md-2 mb-4 margem-recibo">
	...
	<?php if ($row_empresa['Boleto'] == 'S' || $row_empresa['Debito'] == 'S' || $row_empresa['Cartao'] == 'S') { ?>
		<div class="col-md-7 col-sm-7 order-md-1 mb-4 fundo">
				...
				<form name="formPagamento" action="" id="formPagamento">
					...
					<div class="row">
						...
						<div class="col-md-3 mb-3">	
							<label>CPF</label>                            
							<input type="text" name="senderCPF" id="senderCPF" placeholder="CPF sem traço" maxlength="11" value="<?php echo $row_cliente['CpfCliente']; ?>" class="form-control" required>
						</div>
					</div>
					<div class="mb-3">
						<label>E-mail</label>  
					...
					<div class="row creditCard">
						<div class="col-md-6 mb-3 creditCard">
							...
							<input type="text" name="creditCardHolderCPF" id="creditCardHolderCPF" placeholder="CPF sem traço" maxlength="11" value="" class="form-control creditCard" required>
						</div>
						<div class="col-md-6 mb-3 creditCard">

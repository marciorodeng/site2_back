			...
			<div class="col-lg-9">
				...
				<div class="row">
					<?php
						...
						$result_categoria_id = "SELECT * FROM Tab_Catprod WHERE idSis_Empresa = '".$idSis_Empresa."' {$sql_categoria_id} ORDER BY Catprod ASC ";
						...
						if(mysqli_num_rows($read_categoria_id) > '0'){
							foreach($read_categoria_id as $read_categoria_view_id){
								...
								echo'
								<div class="col-md-12">
									<h4 class="ser-title">'.$read_categoria_view_id['Catprod'].'</h4>
									<hr class="botm-line">
								</div>';
									...
									foreach($read_produto_id as $read_produto_view_id){
										...
										<div class="col-lg-4 col-md-6 col-sm-6 mb-4">
											<div class="img-produtos ">
												...
												<div class="card-body">
													<h5 class="card-title">
														<a href="produtosderivados.php?id_modelo='.$read_produto_view_id['idTab_Produto'].'">'.$read_produto_view_id['Produtos'].'</a>
													</h5>
												</div>
											</div>
										</div>
